	...
	; Compiler options:
	;
	; -q --opt=none --chip=16f877a --std=c99 main.c clcd.c i2c.c ds1307.c \
	; adc.c digital_keypad.c isr.c timers.c car_black_box_def.c \
	; -oblackbox.hex --objdir=dist --outdir=dist -L--fixupoverflow=error \
